...
namespace MobileGameTest.Battle
{
    public class Loss : GameState
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            game.spriteBatch.DrawString(DataManager.Instance.localizedMenuFont, "Ты проиграл", new Vector2(230, 250), Color.White);
            game.spriteBatch.DrawString(DataManager.Instance.localizedMenuFont, "Потеряно трофеев: 5", new Vector2(230, 300), Color.White);
